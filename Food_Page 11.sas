...
%macro page11(items,mpage);
  ...
  %let Threshold=1;
  */
*%let Threshold=3;***do not set threshhold!;
%let Threshold=1;
%let VariableCount=9;
...
data subset; 
     merge EmploySummary(where=(sitename="&msite") 
...
data annopage&mpage; set subset2;
   ...
   retain StartBarsY 10 EndBarsY 85  Yposition 10
          ...
          TimePeriods        2       /* Number of time periods per question */
          xsys ysys '3'
		  vncount 0
   ...
   if _n_=1 then do;
     function='label'; color='black'; style="&text1"; 
        ...
        x=50; y=96; style="&text2";  position='B'; 
              text="Comparison of Your Customers";
             /* size=1.7; output;      position='E'; */
			  size=1.5; output;  
x=50; y=94; style="&text2";   position='5'; 
...
position='E';
  ...
  /* Legend        */
          ...
          color='black';    function='label'; y=91.6;  x=39; position='4'; style="&text1";
                            text='Non-Employee'; output;
          color='H0F0EEFF';    function='move';  y=90;  x=40; style='solid'; output;
                            function='bar';   y=92;  x=42;                output;  
          color='black';    function='bar';   y=90;  x=40; style='empty'; output;  

          color='black';    function='label'; y=91.6;  x=59; position='4'; style="&text1";
                            text='Employee';     output;
          color='green';     function='move';  y=90;  x=60; style='solid'; output;
                            function='bar';   y=92;  x=62;                output; 
          color='black';    function='bar';   y=90;  x=60; style='empty'; output;
 ...
 /* footnote */ 
       text='= Average score for all employees for all food service sites combined';     
         /*    function='label'; color='black'; style="&text1"; size=1.2; */
			 function='label'; color='black'; style="&text1"; size=.75;
             x=18; y=5; style="&text1" ;  position='6'; 
           output;  
           style='empty'; color='black'; size=3;
           function='poly';     x=16+0; y=4+0; output;
           function='polycont'; x=16+1; y=4+1; output;
           function='polycont'; x=16-1; y=4+1; output;
           function='polycont'; x=16+0; y=4+0; output;
       text='= Average score for all non-employees for all food service sites combined';     
        /*     function='label'; color='black'; style="&text1"; size=1.2; */
			 function='label'; color='black'; style="&text1"; size=.75;
             x=18; y=3; style="&text1" ;  position='6'; 
           output;  
           style='empty'; color='black'; size=3;
           function='poly';     x=16+0; y=2+1; output;
           function='polycont'; x=16+1; y=2+0; output;
           function='polycont'; x=16-1; y=2+0; output;
           function='polycont'; x=16+0; y=2+1; output;
   end;
   ...
   do i=1 to &VariableCount;
          ...
          Yposition=EndBarsY 
                    ...
                    -3*EndSpace; 
   * put i= 2. +1 Yposition= +2 BarWidth= BarSpace1= BarSpace2= EndSpace= label=; 
          ...
          if obs=1 then color='green'; 
             else do; 
                  color='H0F0EEFF'; line=0; 
             end; 
 ...
 /* Question Text */        
       ...
       /*   x=3; *StartBarsX-13; size=1.1; y=Yposition; */
          ...
          position='C'; text=text1; if obs=1 then output;             
          position='F'; text=text2; if obs=1 then output;             
            
     /* Total Triangles */
          if obs=1 then sign=1; else sign=0;
             when='A'; line=1;
             ...
             function='label';
               x=StartBarsX+TotalAverage;
               y=Yposition+1.20*sign*BarWidth-.1;;
...
%page11(flavor clean handle helpful speed achoice bappear chealth cprice,11);
